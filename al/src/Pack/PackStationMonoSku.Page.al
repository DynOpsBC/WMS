page 72346 "DOPSWHS Mono-SKU Pack Station"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            {
                Caption = 'Scanning';
                InstructionalText = 'Scan an item to pack (box scan closes the order and prints)';
    ...
    begin
        ...
        Rec.SetRange(Mode, Rec.Mode::Batch);
    ...
    begin
        ...
        Completed := PackMgmt.ProcessScan(SessionId, Enum::"DOPSWHS Pack Mode"::Batch, LastScan);
        if WasItemScan then
