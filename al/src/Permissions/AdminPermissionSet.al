permissionset 72094 "DOPSWHS-ADMIN"
{
    ...
    Permissions =
        ...
        tabledata "DOPSWHS Webhook Subscription Audit" = RIMD,
        tabledata "DOPSWHS Pick Reassignment History" = RIMD,
        ...
        table "DOPSWHS Webhook Subscription Audit" = X,
        table "DOPSWHS Pick Reassignment History" = X,
