permissionset 72094 "DOPSWHS-ADMIN"
{
    ...
    Permissions =
        ...
        // --- SM-01..09: Servis Yönetimi modülü ---
        tabledata "DOPSWHS Service Asset" = RIMD,
        table "DOPSWHS Service Asset" = X,
        tabledata "DOPSWHS Service Contract" = RIMD,
        table "DOPSWHS Service Contract" = X,
        tabledata "DOPSWHS Service SLA" = RIMD,
        table "DOPSWHS Service SLA" = X,
        tabledata "DOPSWHS Maintenance Plan" = RIMD,
        table "DOPSWHS Maintenance Plan" = X,
        tabledata "DOPSWHS Work Order" = RIMD,
        table "DOPSWHS Work Order" = X,
        tabledata "DOPSWHS Work Order Line" = RIMD,
        table "DOPSWHS Work Order Line" = X,
        tabledata "DOPSWHS Fault Code" = RIMD,
        table "DOPSWHS Fault Code" = X,
        codeunit "DOPSWHS SLA Monitor" = X,
        codeunit "DOPSWHS Maintenance Scheduler" = X,
        ...
        page "DOPSWHS Service Contracts" = X,
        page "DOPSWHS Service Contract Card" = X,
        page "DOPSWHS Service SLAs" = X,
