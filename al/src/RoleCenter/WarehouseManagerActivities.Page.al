page 72489 "DOPSWHS Warehouse Manager Act"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            {
                Caption = 'Warehouse';
                field("Open Receipts"; Rec."Open Receipts") { ApplicationArea = All; DrillDownPageId = "Warehouse Receipt List"; }
                ...
                field("Devices Online"; Rec."Devices Online") { ApplicationArea = All; DrillDownPageId = "DOPSWHS Device Registration List"; }
            }
        }
    }
