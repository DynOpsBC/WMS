...
internal val TerminalHelpTopics = listOf(
    ...
    HelpTopic(
        ...
        listOf(
            ...
            "Birden fazla kaynak palet varsa açılan listeden başlangıç LP'sini seçin; otomatik yürüyüş için “Raf sırasına göre topla”ya basın.",
            ...
            "Toplama ekranındaki “Hedef LP Oluştur” kaynak palet seçmez; ürünlerin konacağı yeni sevk paletini satır seçmeden açar.",
