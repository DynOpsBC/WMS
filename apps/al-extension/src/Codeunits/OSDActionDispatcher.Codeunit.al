codeunit 50029024 "OSD Action Dispatcher"
{
    Access = Public;
    ...
    /// </summary>
    procedure Dispatch(var Request: Record "OSD Action Request")
    var
        ReceiveSvc: Codeunit "OSD Receive Svc";
        PutawaySvc: Codeunit "OSD Putaway Svc";
        PickSvc: Codeunit "OSD Pick Svc";
        PackSvc: Codeunit "OSD Pack Svc";
        MovementSvc: Codeunit "OSD Movement Svc";
        CountSvc: Codeunit "OSD Cycle Count Svc";
        ProdSvc: Codeunit "OSD Production Svc";
        P: JsonObject;
        Ok: Boolean;
    begin
    ...
    local procedure Finish(var Request: Record "OSD Action Request"; Ok: Boolean; ErrMsg: Text; DocNo: Code[20])
    begin
