table 50029018 "OSD Action Request"
{
    ...
    fields
    {
        ...
        field(6; Status; Enum "OSD Action Status") { Caption = 'Status'; }
        ...
        {
            Caption = 'Device Id';
            TableRelation = "OSD Mobile Device"."Device ID";
    ...
    trigger OnInsert()
    var
        Existing: Record "OSD Action Request";
        Dispatcher: Codeunit "OSD Action Dispatcher";
        Pairing: Codeunit "OSD Pairing Svc";
    begin
