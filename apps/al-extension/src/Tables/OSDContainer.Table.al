table 50029010 "OSD Container"
{
    ...
    fields
    {
        ...
        field(5; Status; Enum "OSD Container Status") { Caption = 'Status'; }
        ...
        field(12; "Created By"; Code[50]) { Caption = 'Created By'; TableRelation = "OSD Worker"."User ID"; }
        field(13; "Closed At"; DateTime) { Caption = 'Closed At'; Editable = false; }
        field(14; "Closed By"; Code[50]) { Caption = 'Closed By'; TableRelation = "OSD Worker"."User ID"; }
