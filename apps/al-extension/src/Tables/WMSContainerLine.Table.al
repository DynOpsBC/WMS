table 50029011 "WMS Container Line"
{
    ...
    fields
    {
        field(1; "Container No."; Code[20]) { Caption = 'Container No.'; TableRelation = "WMS Container"."No."; NotBlank = true; }
        ...
        field(9; "Packed By"; Code[50]) { Caption = 'Packed By'; TableRelation = "WMS Worker"."User ID"; }
