table 50114 "WMS Count Variance"
{
    ...
    fields
    {
        field(1; "Plan No."; Code[20]) { Caption = 'Plan No.'; TableRelation = "WMS Cycle Count Plan"."Plan No."; }
        ...
        field(10; "Counted By"; Code[50]) { Caption = 'Counted By'; TableRelation = "WMS Worker"."User ID"; }
        field(11; "Counted At"; DateTime) { Caption = 'Counted At'; Editable = false; }
        field(12; "Approved By"; Code[50]) { Caption = 'Approved By'; TableRelation = "WMS Worker"."User ID"; }
