table 50029017 "WMS Packing Log"
{
    ...
    fields
    {
        ...
        field(2; "Container No."; Code[20]) { Caption = 'Container No.'; TableRelation = "WMS Container"."No."; }
        field(3; "Event Type"; Enum "WMS Packing Event") { Caption = 'Event Type'; }
        field(4; "Worker ID"; Code[50]) { Caption = 'Worker ID'; TableRelation = "WMS Worker"."User ID"; }
