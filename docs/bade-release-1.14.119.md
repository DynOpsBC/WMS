# BADE 1.14.119 — Terminal MTE = BS Group'un kendi etiketi, ek alanlarla (BC 1.14.1.39 + BadeProduction 1.3.3.13)

Android: **1.14.119-bade**, versionCode **200119**. BC: **BCWMSApp 1.14.1.39** ve **BadeProduction 1.3.3.13**
...
## Ürün / Raf Sorgu etiketi (16 Eyl, 13:30)

Seçili etiket yazıcısı BC'de "aktif ZPL" görünmeyince (yeni kurulan ZD230, ajanın pasife düşürdüğü eski kayıt)
uygulama işi sessizce eski belge yazıcısına yönlendiriyordu. Artık seçili etiket yazıcısı her zaman kullanılır;
BC kaydı uyuşmuyorsa iş yine gönderilir ve ekranda "ajanda Yazıcıları Yenile + Buluta Eşitle" uyarısı çıkar.

## Eski BC ile uyumluluk

Terminal BC'den önce güncellenirse "MTE Yazdır" artık hata vermez: BC `printMte` aksiyonunu tanımıyorsa
...
| APK 200118 / 1.14.119-bade | Aynı sertifika, emülatörde 1.14.116 üzerine kuruldu |
