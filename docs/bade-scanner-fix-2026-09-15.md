...
[BADE 1.14.114](https://github.com/DynOpsBC/WMS/releases/tag/android-v1.14.114) yayımlandı; BADE uygulama içi güncelleme kanalı 200114 olarak herkese açık URL üzerinden doğrulandı. EMU ve eski imzalı EMU kanalları değişmedi.

Kaynak: `WMS-audit-bade-delivery`, `release/bade-1.14.114-scanner`, commit `92b018a3f28206846ceb90afdbddaa6f5df5bbc9`. Yayın kanıtları: `WMS-audit-bade-delivery/output/release-1.14.114/`. Ana WMS çalışma ağacındaki diğer değişiklikler bu yayına dahil edilmedi.
