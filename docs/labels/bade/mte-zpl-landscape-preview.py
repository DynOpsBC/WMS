...
d=dict(company='BS GROUP', itemno='AB.00002', cat='PRİMER AMBALAJ', name='BARDAK - CAM OPAK BORDO SİLİNDİR BASKISIZ 120 ML',
 ...
 storage='ODA SIC. (15-25 °C)', rdate='12.06.2026', rno='107632', insp='DYNOPS', qcname='', qcdate='', doc='', rev='', revd='', qrd='LP000047')
z='^XA^CI28^PW%d^LL%d'%(LW,LH)
z+=box(24,24,1170,764,3)+text(38,34,34,30,250,0,d['company'])+text(24,32,40,36,1170,1,'MADDE TANIMLAMA ETİKETİ')+line(24,78,1170,3)
...
z+=row4(293,43,'ÜRETİM TARİHİ',UY(d['prod']),'LOT NO',UY(d['lot']))+row4(336,43,'SON KULLANMA TARİHİ',UY(d['exp']),'MİKTAR/BİRİM',d['qty'])
...
z+=cell(592,379,216,85,30,28,1,'KABUL')+cell(592,464,216,132,30,28,1,'RED')+cell(592,596,216,160,28,26,1,'KARANTİNA')+box(808,379,386,377,2)+qr(896,433,10,d['qrd'])+text(808,661,40,36,386,1,d['qrd'])
...
open('mte-landscape.zpl','w',encoding='utf-8').write(z)
print(len(z),'bytes')
